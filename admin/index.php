    ...
    <div class="container mt-5 px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        <div class="card card0 border-0">
            <div class="row d-flex">
                ...
                <div class="row">
<div class="card">
                    <div class="card-header font-weight-bold text-capitalize">Management </div>
                        <div class="card-body">
                    <form action="" method="post">
                                    <div class="row px-3"> <label class="mb-1">
                                        <h6 class="mb-0 text-sm">Username :</h6>
                                    </label> <input class="mb-4" type="text" name="username" placeholder="Enter a valid email address" minlength="4" required>
                                </div>
                        <div class="row px-3"> <label class="mb-1">
                        ...
                        <div class="row px-3 mb-4">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <small class="text-muted">default password if its first time 12345 change ur password after login</small>
                            </div>
                        </div>
                            <div class="row mb-3 px-3"> <button type="submit" name="adminlogin"  class="btn btn-blue text-center">Login</button> </div>
                     </form>
                     ...
                     if(isset($_POST['adminlogin'])){
                         ...
                         if($username === "admin" && $password === "12345"){
                            header("Location: home.php" );
                             ...
                             echo "<p class='text-muted text-danger'>Wrong username and password</p>";
                         }
