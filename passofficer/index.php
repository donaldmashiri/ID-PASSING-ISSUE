...
<div class="row">
<div class="card">
                    <div class="card-header font-weight-bold text-capitalize">PASS OFFICER </div>
                    <form action="" method="post">
                        <div class="card-body">
                             <div class="row px-3"> <label class="mb-1">
                                <h6 class="mb-0 text-sm">Pass Officer Email</h6>
                            </label> <input class="mb-4" type="text" name="email" placeholder="Enter a valid Issuing Officer Email"  minlength="4" required>
                         </div>
                <div class="row px-3"> <label class="mb-1">
                    ...
                    <div class="row mb-3 px-3"> <button type="submit" name="isslogin" class="btn btn-blue text-center">Login</button> </div>
                </form>
<?php 
 if (isset($_POST['isslogin'])){
    $email = $_POST['email'];
    $password = $_POST['password'];
    if($email === "passofficer@gmail.com" && $password ==="12345"){
