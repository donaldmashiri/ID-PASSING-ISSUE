    ...
    <div class="container">
        <div class="row profile">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">Search for request</div>
                    <div class="card-body">
                                <h6 class="font-weight-bold text-capitalize text-info">Search for granted employee request</h6>
                                ...
                                <div class="card-header mt-2">Results</div>
                                <table class="table">
...
<?php     
                                ...
                                <?php
                                 if($admin_status === 'approved'){
                                    echo "<a href='home.php?action=approve&req_id=$pass_id' class='btn btn-success'>Approve Payment</a>";
                                }
...
<?php
                     ...
                     if (isset($_GET['action']) && $_GET['action'] == "approve") {
                        ...
                        $query .= "account_status  = '{$approve}' ";
                        $query .= "WHERE pass_id = {$request_id} ";

                        echo "success";

                        header("Location: accreports.php");
